...
window.HAIL_META = {
  ...
  method: [
    ...
    },
    {
      h: "2. 严重度评分（1–5）",
      items: [
        "5：出现人员死亡且伴随大范围破坏；或 ≥10 亿美元损失（以冰雹为主要致损因子）；或 ≥10 cm 巨型冰雹造成大范围破坏；或刷新国家级纪录。",
        "4：损失 1–10 亿美元；或 ≥20 人受伤；或 ≥7 cm 冰雹造成广泛破坏/大范围绝收；或死亡 5 人以上但破坏范围有限。",
        "3：损失 0.1–1 亿美元（1,000 万–1 亿美元）；或 ≥5 cm 冰雹造成明显财产与农业损失；或数十栋房屋损毁；或出现个别死亡。",
        "2：有明显但有限的财产/农业损失；1：以记录性现象为主。",
        "复合事件规则：若损失主要来自冰雹之外的要素（强风、龙卷风、洪涝），即使总额达到十亿美元级（如 NOAA 十亿美元级清单中的强对流事件），严重度下调 1 级，且在事件档案中说明致损构成。",
